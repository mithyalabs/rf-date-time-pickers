...
import React__default, { createElement, useCallback } from 'react';
...
var getTimeValue = function (time, format) {
    ...
    var newTime = isString(time) ? moment(time, format).format("HH:mm").split(":") : moment(time).format("HH:mm").split(":");
    return { hours: newTime[0], minutes: newTime[1] };
};
var MUIDropDownTimePicker = function (props) {
    var classes = useStyles();
    var _a = props.fieldProps, fieldProps = _a === void 0 ? {} : _a, _b = props.formikProps, formikProps = _b === void 0 ? {} : _b, _c = props.fieldConfig, fieldConfig = _c === void 0 ? {} : _c;
    var _d = fieldProps.interval, interval = _d === void 0 ? 5 : _d, _e = fieldProps.clearable, clearable = _e === void 0 ? false : _e, parseFormat = fieldProps.parseFormat, _f = fieldProps.iconButtonProps, iconButtonProps = _f === void 0 ? {} : _f, clearIcon = fieldProps.clearIcon, clearButton = fieldProps.clearButton, _g = fieldProps.hourLabel, hourLabel = _g === void 0 ? 'Hours' : _g, _h = fieldProps.minutesLabel, minutesLabel = _h === void 0 ? 'Minutes' : _h, _j = fieldProps.containerProps, containerProps = _j === void 0 ? {} : _j, onTimeChange = fieldProps.onTimeChange, value = fieldProps.value, _k = fieldProps.selectProps, selectProps = _k === void 0 ? {} : _k, header = fieldProps.header, _l = fieldProps.headerProps, headerProps = _l === void 0 ? {} : _l, startTime = fieldProps.startTime, endTime = fieldProps.endTime;
    var isDisabled = useCallback(function (startTime, endTime, value) {
    ...
    var baseValue = getTimeValue(value ? value : (get(formikProps, "values." + fieldConfig.valueKey) || null), parseFormat);
    var onChange = function (event) {
        var _a;
        event.preventDefault();
        var newValue = __assign(__assign({}, baseValue), (_a = {}, _a[event.target.name] = event.target.value, _a));
        if (onTimeChange)
    ...
    return (React__default.createElement(Box, { width: '100%' },
        header ? React__default.createElement(Typography, __assign({}, headerProps), header) : null,
        React__default.createElement(Box, __assign({ width: '100%', display: 'flex', justifyContent: 'space-between', boxSizing: 'border-box', alignItems: 'flex-end' }, containerProps),
            React__default.createElement(Box, { width: '50%', margin: '0px 5px' },
                React__default.createElement(FormControl, { className: classes.formControl, placeholder: 'data' },
                    React__default.createElement(InputLabel, { id: "hrs" }, hourLabel),
                    React__default.createElement(Select, __assign({ fullWidth: true, value: baseValue.hours || '', name: 'hours', onChange: onChange, placeholder: 'Hours', labelId: 'hrs' }, selectProps), HOURS.map(function (hrs, index) {
                        var disable = isDisabled(startTime || null, endTime || null, __assign(__assign({}, baseValue), { hours: hrs }));
                        return (React__default.createElement(MenuItem, { value: hrs, key: index, disabled: disable }, hrs));
                    })))),
            React__default.createElement(Box, { width: '50%', margin: '0px 5px' },
                React__default.createElement(FormControl, { className: classes.formControl },
                    React__default.createElement(InputLabel, { id: "min" }, minutesLabel),
                    React__default.createElement(Select, __assign({ fullWidth: true, value: baseValue.minutes || '', name: 'minutes', placeholder: 'Minutes', labelId: 'min', onChange: onChange }, selectProps), MINUTES.map(function (min, index) {
                        if (index % interval > 0) {
                        ...
                        if (index % interval === 0)
                            return (React__default.createElement(MenuItem, { value: min, key: index, disabled: disable }, min));
                        return React__default.createElement("div", { key: index });
                    })))),
            clearable && React__default.createElement(Box, null, clearButton ? clearButton : React__default.createElement(IconButton, __assign({ size: 'small', onClick: onClear }, iconButtonProps), clearIcon ? clearIcon : React__default.createElement(ClearIcon, null)))),
        fieldError && React__default.createElement(Typography, { variant: 'overline', className: fieldError ? classes.errorField : '' }, fieldError)));
};
