...
// import { MUIDropDownTimePicker } from './lib';
...
export interface ReadOnlyProps { //2
    renderer: (props: IFieldProps) => React.ReactNode
}
export interface FormConfig { //2 //1
    type: string
    name?: string
    id?: string,
    valueKey: string
...
interface RowSettingsProps { //2 //1 //4
    horizontalSpacing?: number
    verticalSpacing?: number
    columnHorizontalPadding?: number
}
export interface BuilderSettingsProps extends RowSettingsProps { //1 //4
    isReadOnly?: boolean
}

export type RowSchema = Array<FormConfig> | FormConfig | { columns: Array<FormConfig>, settings?: RowSettingsProps }; //2 //1
export interface FormRowProps { //1
    schema: RowSchema
    rowId: string
...
type submitButtonLayout = "right" | "center" | "fullWidth"; //1 //3
export interface IFormActionProps { //1 //3
...
export interface BuilderProps { //2 //1
...
export const BuildFormRow: React.FC<FormRowProps> = props => {  //1
...
export const MLFormContent: React.FC<BuilderProps> = props => { //1
...
export const MLFormAction: React.FC<IFormActionProps & Pick<BuilderProps, 'formId' | 'formikProps'>> = (props) => { //1
...
export const MLFormBuilder: React.FC<BuilderProps> = props => { //1
